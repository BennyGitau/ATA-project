    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('individual', 'Individual'), ('org_consumer', 'Organization Consuming Services'), ('org_provider', 'Organization Providing Services')], max_length=20)),
