...
from .views import register_user, activate_user, login_user, password_reset, delete_account, CustomPasswordResetConfirmView, validate_password_strength, ProfileView
